...
class GcsStorageService(
    ...
    override fun issuePresignedUrl(type: ImageType, contentType: String): Pair<String, String> {
        val extension = contentType.substringAfter("/")
        val objectKey = "${type.prefix}${UUID.randomUUID()}.$extension"
        val blobInfo = BlobInfo.newBuilder(gcsProperties.bucketName, objectKey)
