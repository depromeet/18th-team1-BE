...
internal object QuoteMetadataBatchJobTable {
    ...
    val OPENAI_BATCH_ID = DSL.field(DSL.name("quote_metadata_batch_jobs", "openai_batch_id"), Long::class.java)
    val INPUT_FILE_ID = DSL.field(DSL.name("quote_metadata_batch_jobs", "input_file_id"), Long::class.java)
    val OUTPUT_FILE_ID = DSL.field(DSL.name("quote_metadata_batch_jobs", "output_file_id"), Long::class.java)
    val ERROR_FILE_ID = DSL.field(DSL.name("quote_metadata_batch_jobs", "error_file_id"), Long::class.java)
