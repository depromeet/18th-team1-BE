package com.firstpenguin.app.domain.embedding.service

import com.firstpenguin.app.domain.embedding.dto.ai.OpenAiEmbeddingRequest
import com.firstpenguin.app.domain.embedding.dto.ai.OpenAiEmbeddingResponse
...
class OpenAiEmbeddingClient(
    ...
    fun createEmbedding(
        input: String,
        model: QuoteEmbeddingModelVersion = QuoteEmbeddingModelVersion.V1,
    ...
    private fun requestEmbeddings(
        inputs: List<String>,
        model: QuoteEmbeddingModelVersion,
