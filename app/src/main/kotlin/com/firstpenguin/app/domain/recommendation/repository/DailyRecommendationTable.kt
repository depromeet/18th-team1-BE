...
internal object DailyRecommendationTable {
    ...
    val RECOMMENDATION_DATE = DSL.field(DSL.name("daily_recommendations", "recommendation_date"), LocalDate::class.java)
    val USER_CONTEXT = DSL.field(DSL.name("daily_recommendations", "user_context"), String::class.java)
    val SELECTED_EMOTION_RANGE_ID = DSL.field(DSL.name("daily_recommendations", "selected_emotion_range_id"), Long::class.java)
