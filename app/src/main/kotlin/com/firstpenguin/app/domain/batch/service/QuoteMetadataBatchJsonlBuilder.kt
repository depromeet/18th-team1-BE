...
[embeddingText 작성 기준]
- embeddingText는 사용자 입력의 canonicalIntent와 비교할 검색 설명문이다.
- 이 인용구가 어떤 감정 상태의 사용자에게, 어떤 필요를 충족시키는지 자연어로 설명하라.
- 인용구 원문을 그대로 사용하지 마라.
- tagCode를 쓰지 마라.
- label을 단순 나열하지 마라.
- context나 situation이 명확하지 않으면 장소/상황을 넣지 마라.
- “분류합니다”, “해당합니다”, “태그입니다” 같은 메타 표현을 쓰지 마라.
- 80~140자 사이의 한국어 한 문장으로 작성하라.
    """.trimIndent()
